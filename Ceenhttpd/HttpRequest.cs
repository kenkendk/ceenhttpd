...
namespace Ceenhttpd
{
	...
	public class HttpRequest
	{
		...
		/// </summary>
		/// <value>The form values.</value>
		public IList<MultipartItem> Files { get; private set; }
		/// <summary>
		...
		/// </summary>
		public readonly string LogTaskID;
		...
		public HttpRequest(EndPoint remoteEndpoint, string logtaskid, X509Certificate clientCert)
		{
