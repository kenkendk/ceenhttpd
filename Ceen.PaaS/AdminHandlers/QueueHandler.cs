...
namespace Ceen.PaaS.AdminHandlers
{
    ...
    public class QueuesHandler : Controller, IAdminAPIv1
    {
        /// <summary>
    ...
    /// </summary>
    [Route("queue/{queue}")]
    public class QueueHandler : AdminCRUDHelper<string, Ceen.Extras.QueueModule.QueueEntry>, IAdminAPIv1
    {
        private Dictionary<string, Ceen.Extras.QueueModule> _queues;
        private Ceen.Extras.QueueModule GetQueue()
        {
        ...
        private Ceen.Extras.QueueModule GetQueue(string name)
        {
            if (_queues == null)
        ...
        public override Task<Query<Ceen.Extras.QueueModule.QueueEntry>> OnQueryAsync(AccessType type, string id, Query<Ceen.Extras.QueueModule.QueueEntry> q)
        {
            var queue = GetQueue();
